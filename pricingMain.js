...
const purple= document.querySelectorAll('.dark-purple');
...
document.addEventListener('click', function(e){
    ...
    e.target.closest('.menu-link-login') ||
    e.target.closest('.button') ||
    e.target.closest('.button1') ||
    e.target.closest('.button2')) return //fecha caso click fora de cada classe
